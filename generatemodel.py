...
def pretrainedNetwork(xtrain,ytrain,xtest,ytest,pretrained_model,pretrainedweights,classweight,numclasses,numepochs,optimizer,labels):
    ...
    #tf.compat.v1.saved_model.save(model, model_file)
    return model
...
def main():
    ...
    optimizer1 = keras.optimizers.Adam(lr=0.00005)
    ...
    pretrainedNetwork(X_trainRosReshaped, Y_trainRosHot, X_testRosReshaped, Y_testRosHot,pretrained_model_1,weight_path1,class_weight2,2,15,optimizer1,map_characters1)
